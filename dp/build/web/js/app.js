...
(function(/*! Stitch !*/) {
...
}).call(this)({"collections/menu_list": function(exports, require, module) {(function() {
  var Menu;
  ...
  var ContentView, HomeView, MainRouter, MenuList, MenuListView, Projector, VideoList, VideoListView;
  window.app = {};
  app.routers = {};
  app.models = {};
  app.collections = {};
  ...
  ContentView = require('views/content_view').ContentView;
...
}, "templates/content": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/content_view": function(exports, require, module) {(function() {
  var ProjectorView, VideoListView, contentTemplate;
  ...
  VideoListView = require('views/video_list_view').VideoListView;
  exports.ContentView = (function() {
    __extends(ContentView, Backbone.View);
    ...
    ContentView.prototype.initialize = function() {
      this.projectorView = new ProjectorView({
        model: this.options.projector
      });
      return this.videoListView = new VideoListView({
        collection: this.options.videoList,
  ...
  exports.ProjectorView = (function() {
    ...
    ProjectorView.prototype.initialize = function() {
      ...
      this.model.bind('updateText', this.showText);
      return this.model.bind('updateImage', this.showImage);
    };
    ...
    ProjectorView.prototype.showImage = function(model) {
      var projectorImageView;
  ...
  exports.VideoView = (function() {
    ...
    VideoView.prototype.updateProjector = function(event) {
      if (this.model.get('videoUrl')) {
        ...
        return this.projector.trigger('updateImage', this.model);
      } else {

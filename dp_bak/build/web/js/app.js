...
(function(/*! Stitch !*/) {
...
}).call(this)({"collections/country_list": function(exports, require, module) {(function() {
  var Country;
  ...
  exports.CountryList = (function() {
    __extends(CountryList, Backbone.Collection);
    function CountryList() {
      CountryList.__super__.constructor.apply(this, arguments);
    }
    CountryList.prototype.model = Country;
    CountryList.prototype.url = "" + app.config.jsonPath + "/country_list.json";
    return CountryList;
  })();
}).call(this);
}, "collections/menu_list": function(exports, require, module) {(function() {
  var Menu;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
  ...
  exports.MenuList = (function() {
    __extends(MenuList, Backbone.Collection);
    function MenuList() {
...
}, "collections/video_list": function(exports, require, module) {(function() {
  var Video;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
  ...
  exports.VideoList = (function() {
    __extends(VideoList, Backbone.Collection);
    function VideoList() {
  ...
  var CaseView, CountryList, Elector, HomeView, IndexView, MainRouter, MenuList, MenuListView, Projector, VideoList, VideoListView;
  window.app = {};
  app.routers = {};
  app.models = {};
  app.collections = {};
  ...
  $(document).ready(function() {
    app.initialize = function() {
      ...
      return app.collections.countryList.fetch();
    };
    app.initialize();
...
}, "models/elector": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.Elector = (function() {
    __extends(Elector, Backbone.Model);
    function Elector() {
      Elector.__super__.constructor.apply(this, arguments);
    }
    return Elector;
  })();
}).call(this);
  ...
  exports.Projector = (function() {
    __extends(Projector, Backbone.Model);
    function Projector() {
  ...
  exports.MainRouter = (function() {
    ...
    MainRouter.prototype["case"] = function() {
      return $('#content').html(app.views.caseView.render().el);
    };
    return MainRouter;
  })();
}).call(this);
}, "templates/elector": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/menu": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/menu_list": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/projector_image": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push('<div class="slider-wrapper theme-default">\n    <div class="ribbon"></div>\n    <div id="slider" class="nivoSlider">\n    ');
      _ref = this.image;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        image = _ref[_i];
        __out.push('\n    <img src="');
        __out.push(__sanitize(app.config.imgPath + image));
        __out.push('" />\n    ');
      }
      __out.push('\n    </div>\n</div>\n');
    }).call(this);
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/case_view": function(exports, require, module) {(function() {
  var MapView;
  ...
  exports.CaseView = (function() {
    __extends(CaseView, Backbone.View);
    function CaseView() {
      this.render = __bind(this.render, this);
      CaseView.__super__.constructor.apply(this, arguments);
    }
    CaseView.prototype.initialize = function() {
      return this.mapView = new MapView({
        collection: app.collections.countryList
      });
    };
    CaseView.prototype.render = function() {
      this.$(this.el).html(this.mapView.render().el);
      return this;
    };
    return CaseView;
  })();
}).call(this);
}, "views/elector_view": function(exports, require, module) {(function() {
  var electorTemplate;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
  ...
  exports.ElectorView = (function() {
    __extends(ElectorView, Backbone.View);
    function ElectorView() {
      this.close = __bind(this.close, this);
      this.render = __bind(this.render, this);
      ElectorView.__super__.constructor.apply(this, arguments);
    }
    ElectorView.prototype.id = 'elector';
    ElectorView.prototype.events = {
      'click .close': 'close'
    };
    ElectorView.prototype.initialize = function() {
      return this.model.bind('change', this.render);
    };
    ElectorView.prototype.render = function() {
      var $el, currentLeft, currentTop, event, left, model, parentHeight, parentWidth, top;
      $el = this.$(this.el);
      $el.hide();
      ...
      if (model) {
        ...
        if (currentLeft < parentWidth * 1 / 3) {
          left = currentLeft + 70;
        } else if ((parentWidth / 3 < currentLeft && currentLeft < parentWidth * 2 / 3)) {
          left = currentLeft + 50;
        } else {
...
}, "views/flag_view": function(exports, require, module) {(function() {
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.FlagView = (function() {
    __extends(FlagView, Backbone.View);
    function FlagView() {
      this.mouseout = __bind(this.mouseout, this);
      this.mouseover = __bind(this.mouseover, this);
      this.changeElector = __bind(this.changeElector, this);
      this.render = __bind(this.render, this);
      FlagView.__super__.constructor.apply(this, arguments);
    }
    FlagView.prototype.tagName = 'img';
    FlagView.prototype.events = {
      'click': 'changeElector',
      'mouseover': 'mouseover',
      'mouseout': 'mouseout'
    };
    FlagView.prototype.initialize = function() {
      this.$(this.el).attr('src', "" + app.config.imgPath + "/" + (this.model.get('imgUrl')));
      this.$(this.el).attr('title', this.model.get('name'));
      return this.$(this.el).attr('id', this.model.get('id'));
    };
    FlagView.prototype.render = function() {
      return this;
    };
    FlagView.prototype.changeElector = function(event) {
      return app.models.elector.set({
        model: this.model,
        event: event
      });
    };
    FlagView.prototype.mouseover = function() {
      this.$(this.el).attr('src', "" + app.config.imgPath + "/" + (this.model.get('imgUrlHover')));
      return this.$(this.el).css('z-index', 10);
    };
    FlagView.prototype.mouseout = function() {
      this.$(this.el).attr('src', "" + app.config.imgPath + "/" + (this.model.get('imgUrl')));
      return this.$(this.el).css('z-index', 5);
    };
    return FlagView;
  })();
}).call(this);
...
}, "views/map_view": function(exports, require, module) {(function() {
  var ElectorView, FlagView;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  FlagView = require('views/flag_view').FlagView;
  ElectorView = require('views/elector_view').ElectorView;
  exports.MapView = (function() {
    __extends(MapView, Backbone.View);
    function MapView() {
      this.addCountryList = __bind(this.addCountryList, this);
      this.render = __bind(this.render, this);
    ...
    MapView.prototype.addCountryList = function() {
      ...
      return this.collection.each(function(model) {
        ...
        return $el.append(flagView.render().el);
      });
    };
    return MapView;
  })();
}).call(this);
}, "views/menu_list_view": function(exports, require, module) {(function() {
  var MenuList, MenuView, menuListTemplate;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.MenuListView = (function() {
    __extends(MenuListView, Backbone.View);
    function MenuListView() {
      this.render = __bind(this.render, this);
      MenuListView.__super__.constructor.apply(this, arguments);
    }
    MenuListView.prototype.tagName = 'ul';
    MenuListView.prototype.initialize = function() {
      return this.collection.bind('reset', this.render);
    };
    MenuListView.prototype.render = function() {
      var $el;
      $el = this.$(this.el);
      $el.empty();
      this.collection.each(function(model) {
        ...
        return $el.append(menuView.render().el);
      });
...
}, "views/menu_view": function(exports, require, module) {(function() {
  var menuTemplate;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
  ...
  exports.MenuView = (function() {
    ...
    MenuView.prototype.render = function() {
      this.$(this.el).html(menuTemplate(this.model.toJSON()));
      return this;
    };
    return MenuView;
  })();
  ...
  exports.ProjectorImageView = (function() {
    __extends(ProjectorImageView, Backbone.View);
    function ProjectorImageView() {
      this.render = __bind(this.render, this);
      ProjectorImageView.__super__.constructor.apply(this, arguments);
    }
    ProjectorImageView.prototype.id = 'projector-image';
    ProjectorImageView.prototype.render = function() {
      this.$(this.el).html(projectorImageTemplate(this.model.toJSON()));
      return this;
    };
  ...
  exports.ProjectorView = (function() {
    ...
    ProjectorView.prototype.render = function() {
      ...
      _.delay(function() {
        return model.trigger('show', model);
      }, 3500);
      return this;
    };
    ProjectorView.prototype.update = function() {
      var model;
      model = this.model.get('model');
    ...
    ProjectorView.prototype.showText = function() {
      var $projectorTextView, model, projectorTextView;
      model = this.model.get('model');
      ...
      return $projectorTextView.fadeIn(2000);
    };
    ProjectorView.prototype.showImage = function() {
      var model, projectorImageView;
      model = this.model.get('model');
...
}, "views/video_list_view": function(exports, require, module) {(function() {
  var VideoView;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
  ...
  VideoView = require('views/video_view').VideoView;
  exports.VideoListView = (function() {
    ...
    VideoListView.prototype.initialize = function() {
      ...
      return app.models.projector.bind('show', this.showIntro);
    };
...
}, "views/video_view": function(exports, require, module) {(function() {
  var videoTemplate;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
